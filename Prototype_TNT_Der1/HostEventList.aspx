<%@ Page Title="" Language="C#" MasterPageFile="~/Eventrix.Master" AutoEventWireup="true" CodeBehind="HostEventList.aspx.cs" Inherits="Prototype_TNT_Der1.HostEventList" %>
                        ...
                        <div class="portfolio-item col-sm-6 col-md-4" data-groups='["all", "numbers", "blue", "square"]' ng-repeat="ev in EventDetails | filter:searchEvent">
                            <div class="single-portfolio">
                                ...
                                <div class="portfolio-links" style="width: 200px; margin-left: -120px;">
                                    <li class="fa fa-link">
                                        <a href="EventDetails.aspx?EventID={{ev.EventID}}" style="font-size: 18px; font-family: 'Roboto', sans-serif; color: white;">
                                            <p>{{ev.Name}}</p>
                                            <p>{{ev.sDate}} </p>
                                            <p>{{ev.eDate}}</p>
                                        </a>
                                    ...
                                    <%--<a href="EventDetails.aspx?EventID={{ev.EventID}}"><i class="fa fa-link"></i></a>--%>
                                </div>
                                <!-- /.links -->
                            </div>
                            <!-- /.single-portfolio -->
