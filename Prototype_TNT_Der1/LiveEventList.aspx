<%@ Page Title="" Language="C#" MasterPageFile="~/Eventrix.Master" AutoEventWireup="true" CodeBehind="LiveEventList.aspx.cs" Inherits="Prototype_TNT_Der1.LiveEventList" %>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<ol class="breadcrumb">
								  <li><a href="#">Home</a></li>
								  <li class="active" runat="server" id="li_Heading">Live Event</li>
								</ol>
							</div>
						</div><!-- /.row -->
					</div><!-- /.container-fluid -->
